...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variable.MainList'
        db.add_column('builder_variable', 'MainList',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variable.MainList'
        db.delete_column('builder_variable', 'MainList')
    ...
    models = {
        ...
        'builder.variable': {
            ...
            'MainList': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
